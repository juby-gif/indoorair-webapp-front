...
function onPageLoadRunGetInstrumentDetailsFromAPI(instrument_id) {
    ...
    const detailURL = "{{BACKEND_SERVER_ADDRESS}}/api/instrument/"+instrument_id.toString();
...
function onSubmitClick() {
    ...
    xhttp.open("POST", "{{BACKEND_SERVER_ADDRESS}}/api/instrument/"+instrumentId+"/update", true);
